...
let 快速订阅访问入口 = ['auto'];
let addresses = [];
let addressesapi = ['https://raw.githubusercontent.com/avotcorg/edgetunnel/refs/heads/main/AutoTest.txt'];
...
let socks5Data;
let alpn = 'h3';
let 网络备案 = `<a href='https://t.me/soqunla'>搜群啦</a>`;//写你自己的维护者广告
let 额外ID = '0';
let 加密方式 = 'auto';
...
async function subHtml(request) {
	...
	const HTML = `
			...
			<body>
				<a href="${atob('')}" target="_blank" class="github-corner" aria-label="View source on Github">
